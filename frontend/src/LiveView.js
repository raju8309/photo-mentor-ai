import React, {
  ...
  function LiveView() {
      ...
      const startCamera = async () => {
        try {
          ...
          setHints((prev) => ({
            ...prev,
            exposure_hint:
              "Unable to access webcam. Check browser camera permissions.",
          }));
        }
      };
    ...
    const lightingScore = clamp(
      Math.round((hints.brightness / 255) * 120),
      5,
      100
    );
    ...
    return (
      <>
          ...
          <section className="pm-scene">
            ...
            <div className="pm-scene-frame">
              ...
              <video
                ...
                autoPlay
                playsInline
                className="pm-scene-video"
              />
  
              <div className="pm-scene-bottom-bar">
                <div className="pm-scene-meta">
                  Faces detected: {hints.num_faces || 0}
                </div>
              </div>
            </div>
          </section>
          ...
          <aside className="pm-sidebar">
            <header className="pm-sidebar-header">
              <div>
                ...
                <div className="pm-sidebar-subtitle">
            ...
            <section className="pm-card">
              ...
              <div className="pm-meter-row">
                ...
                <div className="pm-meter">
                  <div
                    className="pm-meter-fill pm-meter-fill-green"
              ...
              <div className="pm-meter-row">
                ...
                <div className="pm-meter">
                  <div
                    className="pm-meter-fill pm-meter-fill-amber"
              ...
              <div className="pm-meter-row">
                ...
                <div className="pm-meter">
                  <div
                    className="pm-meter-fill pm-meter-fill-blue"
              ...
              <div className="pm-meter-row">
                ...
                <div className="pm-meter">
                  <div
                    className="pm-meter-fill pm-meter-fill-purple"
                    style={{ width: `${settingsScore}%` }}
                  />
                </div>
              ...
              <div className="pm-suggestion pm-suggestion-rotation">
                ...
                <div className="pm-suggestion-text">
                  {hints.composition_hint ||
                    "Try aligning your subject on the rule-of-thirds grid."}
                </div>
              </div>
            </section>
        ...
        {showReview && (
          <div
            className="pm-review-backdrop"
            onClick={() => setShowReview(false)}
          >
            <div
              className="pm-review-modal"
                  ...
                  {shots.map((shot, idx) => (
                    <div className="pm-review-card" key={idx}>
                      ...
                      <div className="pm-review-card-actions">
                        ...
                        <button onClick={() => handleDeleteShot(idx)}>
                          Delete
                        </button>
                      </div>
                    </div>
